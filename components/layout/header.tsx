      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link href="#" className="text-ink-300 hover:text-accent-a transition-colors">
              Docs
            </Link>
            <Link href="#" className="text-ink-300 hover:text-accent-a transition-colors">
              Pricing
            ...
            <Button className="gradient-primary hover:scale-105 transition-transform glow-shadow">Get Flow</Button>
          </div>
        </div>
      </div>
    </nav>

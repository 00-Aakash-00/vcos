        ...
        <div className="grid lg:grid-cols-2 justify-around items-center">
          <div className="space-y-8">
            <h1 className="text-6xl lg:text-7xl font-space-grotesk font-extrabold leading-tight">
              AI-powered <span className="text-gradient">deal flow</span> for
              modern <span className="text-gradient">VC firms</span>
            </h1>

            <p className="text-xl text-ink-300 leading-relaxed max-w-lg">
              Streamline your inbound pitches, automate diligence, and close
              deals faster. Spend your time on investment conviction, not
